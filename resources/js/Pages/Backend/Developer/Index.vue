        ...
        >
            <div class="p-6 text-gray-900">
                <div id="content" class="">
                    ...
                    <Header title="main.developer-list"></Header>
                        ...
                        <div v-if="developers">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="width: 100%">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                                    v-for="(developer,index) in developers.data" :key="index">
                                    ...
                                    <a target="_blank" :href="developer.google_url"><ion-icon name="logo-google-playstore" class=" text-2xl text-cyan-500 font-extrabold"></ion-icon></a>
                                    </td>
                                    <td class="px-2 py-2">
                  <span v-if="developer.status"
                        class="bg-green-600 text-white py-1 px-2 rounded-md font-normal">Published</span>
                                    ...
                                    <td class="px-2 py-2 space-x-3">
                                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                           v-on:click="openUpdateModal(developer)">
                                            <ion-icon name="create"
                                                      class="pt-2 " size="large"></ion-icon>
                                        </a>
                                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                                           v-on:click="openDeleteModal(developer)">
                            ...
                            <Pagination :meta="developers.meta"></Pagination>
                        </div>
                ...
                <Modal :show="isShowDelete">
                    <div class="pb-10 m-10 border-x border-t rounded-md">
                        ...
                        <div class="bg-red-100 p-5 text-red-700 space-y-2 rounded-md">
                            <h2 class="flex space-x-2"><ion-icon name="alert-circle-outline" class="text-3xl"></ion-icon> <span class="text-2xl">Delete Developer</span></h2>
