...
const versionById = (id) => {
  return editForm = props.app?.versions.find(v=>v.id === id)
...
const openUpdateModal = (app) => {
    ...
    // editForm.version_code = app.version_code;
    // editForm.screen_dpi = app.screen_dpi;
    // editForm.sha1 = app.sha1;
    // editForm.sha256 = app.sha256;
    // editForm.md5 = app.md5;
    // editForm.minimum_android = app.minimum_android;
    // editForm.minimum_android_level = app.minimum_android_level;
    // editForm.target_android = app.target_android;
    // editForm.target_android_level = app.target_android_level;
    // editForm.architecture = app.architecture;
    // editForm.permissions = app.permissions;
    // editForm.languages = app.languages;
    // editForm.signature = app.signature;
    // editForm.file = app.file;
    // editForm.file_size = app.file_size;
    // editForm.file_type = app.file_type;
    // editForm.date = app.date;
    // editForm.whats_new = app.whats_new;
}
                                    ...
                                    <div class="flex space-x-3 bg-gray-50">
                                        ...
                                        <div class="flex flex-col ">
                                            ...
                                            <div class="flex space-x-3 items-center">
                                                ...
                                                <vue3-star-ratings v-model="app.rating"
                                ...
                                <div class="border mt-5 " v-if="app.screenshots">
                                    ...
                                    <div class="flex space-x-3 overflow-x-scroll bg-green-600">
                                        <img v-for="screenshot in app.screenshots" :src="screenshot.photo" alt=""
                                             width="180" class="shadow-2xl rounded-sm border m-2 ">
                                    </div>
                                </div>
